...
export const CREATE_INPUT_NODE: string = "createInputNode";
export const CREATE_INPUT_NODE_COLOUR_SENSOR: string = "createInputNodeColourSensor";
export const CREATE_OUTPUT_NODE: string = "createOutputNode";
...
export const PROCESS_NEURAL_NETWORK: string = "processNeuralNetwork";
export const QLEARNING_STARTNODE: string = "qlearningStartNode";
export const QLEARNING_FINISHNODE: string = "qlearningFinishNode";
export const Q_LEARNING_ALPHA: string = "qLearningAlpha";
export const Q_LEARNING_GAMMA: string = "qLearningGamma";
export const Q_LEARNING_NU: string = "qLearningNu";
export const Q_LEARNING_RHO: string = "qLearningRho";
export const Q_LEARNING_DRAW_OPTIMAL_PATH: string = "qLearningDrawOptimalPath";
...
export const RUN_Q_LEARNER: string = "runQLearner";
...
export const SETUP_Q_LEARNING_BEHAVIOUR: string = "setupQLearningBehaviour";
