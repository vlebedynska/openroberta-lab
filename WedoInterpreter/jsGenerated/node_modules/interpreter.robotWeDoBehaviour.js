...
(function (factory) {
    ...
    var RobotWeDoBehaviour = /** @class */ (function (_super) {
        ...
        // @ts-ignore
        RobotWeDoBehaviour.prototype.extractColourChannelAndNormalize = function (node) {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviour.prototype.processNeuralNetwork = function (inputLayer, outputLayer) {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviour.prototype.createQLearningEnvironment = function (obstaclesList, startNode, finishNode) {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviour.prototype.setUpQLearningBehaviour = function (alpha, gamma, nu, rho) {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviour.prototype.runQLearner = function () {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviour.prototype.drawOptimalPath = function () {
            throw new Error("Method not implemented.");
        };
