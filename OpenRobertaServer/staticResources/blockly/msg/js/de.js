...
Blockly.Msg.RL_BARRIER_MOUNTAIN = "Berg zwischen";
Blockly.Msg.RL_BARRIER_MOUNTAIN_TOOLTIP = "Setzt einen Berg zwischen zwei Feldern.";
Blockly.Msg.RL_DRAW_OPTIMAL_PATH = "Zeichne den optimalen Weg";
Blockly.Msg.RL_DRAW_OPTIMA_PATH_TOOLTIP = "Mit der gewonnen Erfahrung wird der optimale Weg auf der Karte gezeichnet.";
Blockly.Msg.RL_DRIVE_OPTIMA_PATH = "fahre den optimalen Weg";
Blockly.Msg.RL_DRIVE_OPTIMA_PATH_TOOLTIP = "Mit der gewonnenen Erfahrung fährt der Roboter die optimale Bahn.";
Blockly.Msg.RL_EXPERIENCE = "Erfahrung";
Blockly.Msg.RL_EXPERIENCE_MUCH = "viel: Nutze dein bestehendes Wissen aus";
Blockly.Msg.RL_EXPERIENCE_NONE = "keine: auf zu den neuen Ufern!";
Blockly.Msg.RL_EXPERIENCE_SOME = "mittel: vorhandenes Wissen nutzen und neue Dinge erforschen";
Blockly.Msg.RL_FAST = "schnell";
Blockly.Msg.RL_FINISH_POSITION = "Ziel";
Blockly.Msg.RL_GAIN_EXPERIENCE = "sammle Erfahrung";
Blockly.Msg.RL_GAIN_EXPERIENCE_TOOLTIP = "Lässt den Roboter auf dem aktuellen Feld Erfahrungen sammeln und dadurch lernen.";
Blockly.Msg.RL_LEARNING_SPEED = "Lerntempo";
Blockly.Msg.RL_MEDIUM = "mittel";
Blockly.Msg.RL_PLACE_OBSTACLE = "setze Hindernisse";
Blockly.Msg.RL_Q_LEARNER_CONFIG_SET_UP_LEARNING_BEHAVIOUR = "stelle das Lernverhalten ein";
Blockly.Msg.RL_Q_LEARNER_CONFIG_TOOLTIP = "Legt Richtlinien für das Lernverhalten des Roboters fest.";
Blockly.Msg.RL_REWARD = "Belohnung";
Blockly.Msg.RL_REWARD_IMMEDIATE = "sofort";
Blockly.Msg.RL_REWARD_LATER = "später";
Blockly.Msg.RL_SLOW = "langsam";
Blockly.Msg.RL_STARTING_POSITION = "Start";
Blockly.Msg.RL_STARTING_POSITION_ACHIEVED_IN_PREVIOUS_STATE = "bleibe auf dem Pfad";
Blockly.Msg.RL_STARTING_POSITION_RANDOM = "suche den Startpunkt zufällig";
Blockly.Msg.RL_START_POSITION = "Startposition";
Blockly.Msg.RL_STATES_AND_ACTIONS_MATRIX_TOOLTIP = "Konfiguriert die Karte, die der Roboter erkunden soll.";
...
Blockly.Msg.VARIABLES_TYPE_NN_ARRAY_INPUT = "List Input";
Blockly.Msg.VARIABLES_TYPE_NN_ARRAY_OUTPUT = "List Output";
Blockly.Msg.VARIABLES_TYPE_NUMBER = "Zahl";
Blockly.Msg.VARIABLES_TYPE_RL_ARRAY_OBSTACLE = "Liste Hindernis";
Blockly.Msg.VARIABLES_TYPE_STRING = "Zeichenkette";
Blockly.Msg.VARIABLE_TYPE_NN_INPUT = "Input";
Blockly.Msg.VARIABLE_TYPE_NN_INPUT_TOOLTIP = "Das ist der Input-Knoten des Netzwerks";
Blockly.Msg.VARIABLE_TYPE_NN_OUTPUT = "Output";
Blockly.Msg.VARIABLE_TYPE_NN_OUTPUT_TOOLTIP = "Das ist der Output-Knoten des Netzwerks";
Blockly.Msg.VARIABLE_TYPE_RL_OBSTACLE = "Hindernis";
