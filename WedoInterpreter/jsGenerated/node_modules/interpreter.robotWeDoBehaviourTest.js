...
(function (factory) {
    ...
    var RobotWeDoBehaviourTest = /** @class */ (function (_super) {
        ...
        RobotWeDoBehaviourTest.prototype.createQLearningEnvironment = function (obstaclesList, startNode, finishNode) {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviourTest.prototype.setUpQLearningBehaviour = function (alpha, gamma, nu, rho) {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviourTest.prototype.runQLearner = function () {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviourTest.prototype.drawOptimalPath = function () {
            throw new Error("Method not implemented.");
        };
        RobotWeDoBehaviourTest.prototype.extractColourChannelAndNormalize = function (node) {
            throw new Error("Method not implemented.");
        };
