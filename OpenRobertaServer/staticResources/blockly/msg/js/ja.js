...
Blockly.Msg.MAP = "map";  // untranslated
...
Blockly.Msg.NEURAL_NETWORK_TOOLTIP = "This is the neural network";  // untranslated
...
Blockly.Msg.RL_BARRIER_MOUNTAIN = "rock between";  // untranslated
Blockly.Msg.RL_BARRIER_MOUNTAIN_TOOLTIP = "Places a rock between two fields.";  // untranslated
Blockly.Msg.RL_DRAW_OPTIMAL_PATH = "draw the optimal path";  // untranslated
Blockly.Msg.RL_DRAW_OPTIMA_PATH_TOOLTIP = "Using the experience gained draws the optimal path.";  // untranslated
Blockly.Msg.RL_DRIVE_OPTIMA_PATH = "drive the optimal path";  // untranslated
Blockly.Msg.RL_DRIVE_OPTIMA_PATH_TOOLTIP = "Using the experience gained lets the robot drive the optimal path.";  // untranslated
Blockly.Msg.RL_EXPERIENCE = "expirience";  // untranslated
Blockly.Msg.RL_EXPERIENCE_MUCH = "much: use your existing knowledge";  // untranslated
Blockly.Msg.RL_EXPERIENCE_NONE = "none: off to new shores";  // untranslated
Blockly.Msg.RL_EXPERIENCE_SOME = "some: use existing knowledge and explore new things";  // untranslated
Blockly.Msg.RL_FAST = "fast";  // untranslated
Blockly.Msg.RL_FINISH_POSITION = "finish";  // untranslated
Blockly.Msg.RL_GAIN_EXPERIENCE = "gain experience";  // untranslated
Blockly.Msg.RL_GAIN_EXPERIENCE_TOOLTIP = "Lets the robot gain experience in the current field and thus learn.";  // untranslated
Blockly.Msg.RL_LEARNING_SPEED = "learning speed";  // untranslated
Blockly.Msg.RL_MEDIUM = "medium";  // untranslated
Blockly.Msg.RL_PLACE_OBSTACLE = "place obstacles";  // untranslated
Blockly.Msg.RL_Q_LEARNER_CONFIG_SET_UP_LEARNING_BEHAVIOUR = "set up the learning behaviour";  // untranslated
Blockly.Msg.RL_Q_LEARNER_CONFIG_TOOLTIP = "Sets guidelines for the learning behavior of the robot.";  // untranslated
Blockly.Msg.RL_REWARD = "reward";  // untranslated
Blockly.Msg.RL_REWARD_IMMEDIATE = "immediately";  // untranslated
Blockly.Msg.RL_REWARD_LATER = "later";  // untranslated
Blockly.Msg.RL_SLOW = "slow";  // untranslated
Blockly.Msg.RL_STARTING_POSITION = "start";  // untranslated
Blockly.Msg.RL_STARTING_POSITION_ACHIEVED_IN_PREVIOUS_STATE = "stay on path";  // untranslated
Blockly.Msg.RL_STARTING_POSITION_RANDOM = "search the start point randomly";  // untranslated
Blockly.Msg.RL_START_POSITION = "startposition";  // untranslated
Blockly.Msg.RL_STATES_AND_ACTIONS_MATRIX_TOOLTIP = "Configures the map that the robot should explore.";  // untranslated
...
Blockly.Msg.TOOLBOX_NEURAL_NETWORKS = "Neural Networks";  // untranslated
Blockly.Msg.TOOLBOX_PIN = "Pin";  // untranslated
Blockly.Msg.TOOLBOX_PROCEDURE = "Functions";  // untranslated
Blockly.Msg.TOOLBOX_REINFORCEMENT_LEARNING = "Reinforcement Learning";  // untranslated
...
Blockly.Msg.VARIABLES_TYPE_NN_ARRAY_INPUT = "List Input";  // untranslated
Blockly.Msg.VARIABLES_TYPE_NN_ARRAY_OUTPUT = "List Output";  // untranslated
Blockly.Msg.VARIABLES_TYPE_NUMBER = "Number";  // untranslated
Blockly.Msg.VARIABLES_TYPE_RL_ARRAY_OBSTACLE = "List Obstacle";  // untranslated
Blockly.Msg.VARIABLES_TYPE_STRING = "String";  // untranslated
Blockly.Msg.VARIABLE_TYPE_NN_INPUT = "Input";  // untranslated
Blockly.Msg.VARIABLE_TYPE_NN_INPUT_TOOLTIP = "The input node of the network";  // untranslated
Blockly.Msg.VARIABLE_TYPE_NN_OUTPUT = "Output";  // untranslated
Blockly.Msg.VARIABLE_TYPE_NN_OUTPUT_TOOLTIP = "The output node of the network";  // untranslated
Blockly.Msg.VARIABLE_TYPE_RL_OBSTACLE = "Obstacle";  // untranslated
